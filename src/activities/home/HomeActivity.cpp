...
int HomeActivity::getMenuItemCount() const {
  int count = 4;  // My Library, File transfer, My Pet, Settings
...
void HomeActivity::render() {
  ...
  std::vector<const char*> menuItems = {"My Library", "File Transfer", "My Pet", "Settings"};
  if (hasOpdsUrl) {
